...
class StrictRedis(object):
    ...
    #collection
    def cltp_insert(self, uid, *args):
         return self.execute_command('CLTP_INSERT', uid, *args)

    def cltp_upsert(self, uid, *args):
         return self.execute_command('CLTP_UPSERT', uid, *args)

    def cltp_update(self, uid, *args):
         return self.execute_command('CLTP_UPDATE', uid, *args)

    def cltp_create(self, uid, *args):
         return self.execute_command('CLTP_CREATE', uid, *args)

    def cltp_find(self, uid, *args):
         return self.execute_command('CLTP_FIND', uid, *args)

    def cltp_get(self, uid, *args):
         return self.execute_command('CLTP_GET', uid, *args)

    def cltp_stat(self, uid, *args):
         return self.execute_command('CLTP_STAT', uid, *args)

    def cltp_drop(self, uid, *args):
         return self.execute_command('CLT_DROP', uid, *args)

    def cltp_remove(self, uid, *args):
         return self.execute_command('CLTP_REMOVE', uid, *args)

    def cltp_clear(self, uid, *args):
         return self.execute_command('CLT_CLEAR', uid, *args)
