...
static RedisCommand_raw cmds_raw[] = {
	...
	{STRATEGY_AUTO, 			"del",				"del",					REPLY_INT},
	...
	{STRATEGY_SETEX,			"setex",			"setex", 				REPLY_STATUS},
	...
	{STRATEGY_AUTO, 			"psetex",			"psetex",				REPLY_STATUS},
	{STRATEGY_AUTO, 			"incr",				"incr",					REPLY_INT},
	{STRATEGY_AUTO, 			"incrby",			"incrby",				REPLY_INT},
	{STRATEGY_AUTO, 			"decr",				"decr",					REPLY_INT},
	{STRATEGY_AUTO, 			"decrby",			"decrby",				REPLY_INT},
	...
	{STRATEGY_AUTO, 			"substr",			"substr",				REPLY_BULK},
	{STRATEGY_AUTO, 			"getrange",			"getrange",				REPLY_BULK},
	{STRATEGY_AUTO, 			"keys", 			"keys", 				REPLY_MULTI_BULK},
	{STRATEGY_AUTO, 			"rkeys", 			"rkeys", 				REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"scan",				"scan",					REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"rscan",			"rscan",				REPLY_MULTI_BULK},
	{STRATEGY_AUTO, 			"mset",				"multi_set",			REPLY_STATUS},
	{STRATEGY_MGET, 			"mget",				"multi_get",			REPLY_MULTI_BULK},
	{STRATEGY_AUTO, 			"msetnx",			"multi_setnx",			REPLY_INT},

	{STRATEGY_AUTO, 			"hset",				"hset",					REPLY_INT},
	{STRATEGY_AUTO, 			"hsetv",			"hsetv",				REPLY_MULTI_BULK},
	{STRATEGY_AUTO, 			"hget",				"hget",					REPLY_BULK},
	{STRATEGY_AUTO, 			"hgetv",    		"hgetv",				REPLY_MULTI_BULK},
	...
	{STRATEGY_AUTO, 			"hsize",			"hsize",				REPLY_INT},
	{STRATEGY_AUTO, 			"hincr",			"hincr",				REPLY_INT},
	{STRATEGY_AUTO, 			"hdecr",			"hdecr",				REPLY_INT},
	{STRATEGY_AUTO, 			"hincrby",			"hincr",				REPLY_INT},
	{STRATEGY_AUTO, 			"hdecrby",			"hdecr",				REPLY_INT},
	{STRATEGY_AUTO,				"hscan",			"hscan",				REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"hrscan",			"hrscan",				REPLY_MULTI_BULK},
	{STRATEGY_HMGET,			"hmget",			"multi_hget",			REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"hlist",			"hlist",				REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"hrlist",			"hrlist",				REPLY_MULTI_BULK},
	...
	{STRATEGY_AUTO,				"zlist",			"zlist",				REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"zrlist",			"zrlist",				REPLY_MULTI_BULK},
	{STRATEGY_AUTO, 			"zcard",			"zsize",				REPLY_INT},
	{STRATEGY_AUTO, 			"zsize",			"zsize",				REPLY_INT},
	{STRATEGY_AUTO, 			"zscore",			"zget",					REPLY_BULK},
	{STRATEGY_AUTO, 			"zget",				"zget",					REPLY_BULK},
	{STRATEGY_AUTO, 			"zrem",				"multi_zdel",			REPLY_INT},
	{STRATEGY_AUTO, 			"zrank",			"zrank",				REPLY_INT},
	{STRATEGY_AUTO, 			"zrevrank",			"zrrank",				REPLY_INT},
	{STRATEGY_AUTO, 			"zrrank",			"zrrank",				REPLY_INT},
	{STRATEGY_AUTO, 			"zcount",			"zcount",				REPLY_INT},
	{STRATEGY_AUTO, 			"zexists",			"zexists",				REPLY_INT},
	...
	{STRATEGY_ZADD,				"zset",				"zset", 				REPLY_INT},
	{STRATEGY_ZADD,				"zmset",			"multi_zset", 			REPLY_INT},
	{STRATEGY_AUTO, 			"zmget",			"multi_zget",			REPLY_MULTI_BULK},
	{STRATEGY_ZADD,				"zmadd",			"multi_zset", 			REPLY_INT},
	{STRATEGY_ZINCRBY,			"zincrby",			"zincr", 				REPLY_INT},
	{STRATEGY_ZINCRBY,			"zdecrby",			"zdecr", 				REPLY_INT},
	{STRATEGY_AUTO,				"zincr",			"zincr", 				REPLY_INT},
	{STRATEGY_AUTO,				"zdecr",			"zdecr", 				REPLY_INT},
	{STRATEGY_AUTO,				"zscan",			"zscan", 				REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"zrscan",			"zrscan", 				REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"zkeys",			"zkeys", 				REPLY_MULTI_BULK},
	{STRATEGY_ZRANGEBYSCORE,	"zrangebyscore",	"zrangebyscore",		REPLY_MULTI_BULK},
	{STRATEGY_ZREVRANGEBYSCORE,	"zrevrangebyscore",	"zrevrangebyscore",		REPLY_MULTI_BULK},
	...
	{STRATEGY_AUTO,				"lpush",			"lpush_front", 			REPLY_INT},
	{STRATEGY_AUTO,				"rpush",			"lpush_back", 			REPLY_INT},
	{STRATEGY_AUTO,				"lpop",				"lpop_front", 			REPLY_BULK},
	{STRATEGY_AUTO,				"rpop",				"lpop_back", 			REPLY_BULK},
	{STRATEGY_AUTO, 			"llen",				"lsize",				REPLY_INT},
	{STRATEGY_AUTO, 			"lsize",			"lsize",				REPLY_INT},
	{STRATEGY_AUTO,				"lindex",			"lget", 				REPLY_BULK},
	{STRATEGY_AUTO,				"lset",		   	 	"lset", 				REPLY_STATUS},
	{STRATEGY_AUTO,				"lrange",			"lrange",				REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"lfront",			"lfront", 				REPLY_BULK},
	{STRATEGY_AUTO,				"lback",			"lback", 				REPLY_BULK},
	{STRATEGY_AUTO,				"ltrim",			"ltrim_front", 			REPLY_INT},
	{STRATEGY_AUTO,				"rtrim",			"ltrim_back", 			REPLY_INT},
	{STRATEGY_AUTO,				"llist",			"llist",				REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"lrlist",			"lrlist",				REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"llist",			"llist",				REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"lrlist",			"lrlist",				REPLY_MULTI_BULK},
			
	{STRATEGY_TABLE,			"clt_create",		"clt_create", 			REPLY_INT},
	{STRATEGY_TABLE,			"clt_isbuilding",	"clt_isbuilding", 		REPLY_INT},
	{STRATEGY_TABLE,			"cltp_isbuilding",	"clt_isbuilding", 		REPLY_INT},
	{STRATEGY_TABLE,			"clt_insert",		"clt_insert", 			REPLY_INT},
	{STRATEGY_TABLE,			"clt_upsert",		"clt_upsert", 			REPLY_INT},
	{STRATEGY_TABLE,			"clt_find",			"clt_find", 			REPLY_MULTI_BULK},
	{STRATEGY_TABLE,			"clt_update",		"clt_update", 			REPLY_INT},
	{STRATEGY_TABLE,			"clt_remove",		"clt_remove", 			REPLY_INT},
	{STRATEGY_TABLE,			"cltp_create",		"clt_create_pretty", 	REPLY_INT},
	{STRATEGY_TABLE,			"cltp_insert",		"clt_insert_pretty", 	REPLY_INT},
	{STRATEGY_TABLE,			"cltp_upsert",		"clt_upsert_pretty", 	REPLY_INT},
	{STRATEGY_TABLE,			"cltp_find",		"clt_find_pretty", 		REPLY_MULTI_BULK},
	{STRATEGY_TABLE,			"cltp_update",		"clt_update_pretty", 	REPLY_INT},
	{STRATEGY_TABLE,			"cltp_remove",		"clt_remove_pretty", 	REPLY_INT},
	{STRATEGY_TABLE,			"cltp_update",		"clt_update_pretty", 	REPLY_INT},
	{STRATEGY_TABLE,			"cltp_remove",		"clt_remove_pretty", 	REPLY_INT},
	{STRATEGY_TABLE,			"clt_clear",		"clt_clear", 			REPLY_INT},
	{STRATEGY_TABLE,			"cltp_clear",		"clt_clear", 			REPLY_INT},
	{STRATEGY_TABLE,			"clt_recreate",		"clt_recreate", 		REPLY_BULK},
	{STRATEGY_TABLE,			"cltp_recreate",	"clt_recreate_pretty", 	REPLY_BULK},
	{STRATEGY_TABLE, 			"cltp_get",			"clt_get_pretty", 		REPLY_BULK},
	{STRATEGY_TABLE, 			"clt_get",			"clt_get", 				REPLY_BULK},
	{STRATEGY_TABLE,			"cltp_mget",		"clt_multi_get_pretty", REPLY_MULTI_BULK},
	{STRATEGY_TABLE,			"clt_mget",			"clt_multi_get", 		REPLY_MULTI_BULK},
	{STRATEGY_TABLE, 			"clt_stat",			"clt_stat", 			REPLY_BULK},
	{STRATEGY_TABLE, 			"cltp_stat",		"clt_stat_pretty", 		REPLY_BULK},


	{STRATEGY_SLOTSINFO, 		"slotsinfo",		"slotsinfo",			REPLY_SLOTSINFO},
	{STRATEGY_AUTO,		 		"slotshashkey",		"slotshashkey",			REPLY_INT},
	{STRATEGY_SLOTSDEL,	 		"slotsdel",			"slotsdel",				REPLY_INT},
	{STRATEGY_AUTO,		 		"slotsmgrttagslot",	"slotsmgrttagslot",		REPLY_MULTI_BULK},
	{STRATEGY_SLOTSRESTORE,  	"slotsrestore",		"slotsrestore",			REPLY_SLOTSRESTORE},
	{STRATEGY_AUTO,				"role",	            "role",					REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"config",			"config",				REPLY_MULTI_BULK},
	{STRATEGY_AUTO,				"slaveof",			"slaveof",				REPLY_STATUS},
	{STRATEGY_AUTO,				"slotsmgrttagone",	"slotsmgrttagone",		REPLY_INT},
	{STRATEGY_AUTO,				"info",				"info",					REPLY_BULK},
	{STRATEGY_AUTO,				"compact",			"compact",				REPLY_BULK},
	{STRATEGY_AUTO,				"retrievekey",		"retrievekey",			REPLY_BULK},
	{STRATEGY_AUTO,				"dbsize",		    "dbsize",				REPLY_BULK},
	{STRATEGY_AUTO,				"keysize",		    "keysize",				REPLY_BULK},
	{STRATEGY_AUTO,     		"namespaces",       "namespaces",           REPLY_MULTI_BULK},
	{STRATEGY_AUTO,     		"alarm",			"alarm",				REPLY_BULK},
	{STRATEGY_AUTO,				"lowertime",		"lowertime",			REPLY_BULK},
	{STRATEGY_AUTO,				"dbsizecron",		"dbsizecron",			REPLY_BULK},
	{STRATEGY_AUTO,		 		"slotsmgrttagone",	"slotsmgrttagone",		REPLY_INT},
...
int RedisLink::send_resp(Buffer *output, const std::vector<std::string> &resp){
	...
	if(resp[0] != "ok"){
		if (resp[0] == "error" || resp[0] == "fail" || resp[0] == "client_error") {
			...
			output->append("\r\n");
		} else if (resp[0] == "datatype_invalid") {
			output->append("-ERR Operation key holding the wrong kind of value");
			output->append("\r\n");
		} else if(resp[0] == "empty_list"){
			output->append("(empty list or set)");
			output->append("\r\n");
		}else if(resp[0] == "key_expire"){
			output->append("-ERR key expire");
			output->append("\r\n");
		}else if(resp[0] == "parsing value error"){
			output->append("-ERR parsing value error");
			output->append("\r\n");
		}else if(resp[0] == "slotsinfo_empty"){//判断slotsinfo为空标记
			output->append("*0\r\n");
		}else if (resp[0] == "crc32_error"){//slotsmgrtrestore crc32 error
			output->append("-");
			output->append("\r\n");
		}else if (resp[0] == "slotsmgrtrestore_fail"){//slotsmgrtrestore fail
			output->append("-");
			output->append("\r\n");
		}else if(resp[0] == "slotsrestore_succ"){//判断slotsrestore成功
			output->append("+\r\n");
		}else if (resp[0] == "connect_failed"){//slotsmgrtslot conn failed
			output->append("-ERR connect_failed");
			output->append("\r\n");
		}else if (resp[0] == "no_slotsdata"){//slotsmgrtslot no slots data
			output->append("-ERR no_slotsdata");
			output->append("\r\n");
		}else if (resp[0] == "send_fail"){//slotsmgrtslot send_fail
			output->append("-ERR send_faile");
			output->append("\r\n");
		}else if (resp[0] == "recv_fail"){//slotsmgrtslot recv_fail
			output->append("-ERR recv_faile");
			output->append("\r\n");
		}else if (resp[0] == "migrate_slave_invalid") {
        	output->append("-ERR mgrt_to_slave_invalid");
        	output->append("\r\n");
    	}else{
			output->append("-ERR Internal server error\r\n");
		}
	...
	if (req_desc->reply_type == REPLY_SLOTSINFO
			&& req_desc->strategy == STRATEGY_SLOTSINFO){//拼凑slotinfo返回数据，按照codis-redis格式
		int respsize = resp.size();
		int slotscount = 0;

		if (respsize % 2 == 1 && respsize > 2){
			for(int i = 1; i < respsize; i = i + 2){
				if (!slotscount){
					char slots[16] = {'\0'};
					slotscount = respsize / 2;
					snprintf(slots, sizeof(slots) - 1, "%d", slotscount);
					output->append("*");
					output->append(slots);
					output->append("\r\n");
				}
				...
				output->append(":");
				output->append(resp[i]);
				output->append("\r\n");

				output->append(":");
				output->append(resp[i+1]);
				output->append("\r\n");
	...
	if (req_desc->reply_type == REPLY_SLOTSDEL
			&& req_desc->strategy == STRATEGY_SLOTSDEL){//拼凑slotdel返回数据
		int respsize = resp.size();

		if (respsize % 2 == 0 && respsize >= 2){
			int slotcount = respsize / 2;
			char slots[16] = {'\0'};
			snprintf(slots, sizeof(slots) - 1, "%d", slotcount);
			output->append("*");
			output->append(slots);
			output->append("\r\n");
	...
	if (req_desc->reply_type == REPLY_SLOTSRESTORE
			&& req_desc->strategy == STRATEGY_SLOTSRESTORE){//对应slotsrestore返回数据
	}
